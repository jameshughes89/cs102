...
public class HuffmanCodeTest {
    ...
    static final Map<String, String> SIMPLE_PREFIX = Map.ofEntries(Map.entry("a", "1"), Map.entry("b", "01"), Map.entry("c", "00"));
    ...
    private static final Map<String, String> WIKI_PREFIX = Map.ofEntries(Map.entry(" ", "111"), Map.entry("a", "000"), Map.entry("e", "001"), Map.entry("f", "1101"), Map.entry("h", "0110"), Map.entry("i", "0111"), Map.entry("m", "0100"), Map.entry("n", "0101"), Map.entry("s", "1000"), Map.entry("t", "1001"), Map.entry("l", "11000"), Map.entry("o", "11001"), Map.entry("p", "10100"), Map.entry("r", "10101"), Map.entry("u", "10110"), Map.entry("x", "10111"));
    /*
