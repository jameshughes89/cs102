...
public class ArrayIteratorTest {
    ...
    class WhenEmpty {
        ...
        @Test
        void hasNext_emptyCapacityZero_returnsFalse() {
            ArrayIterator<Integer> iterator = new ArrayIterator<>(new Integer[]{}, 0);
            assertFalse(iterator.hasNext());
        }

        @Test
        void hasNext_emptyCapacityOne_returnsFalse() {
            ArrayIterator<Integer> iterator = new ArrayIterator<>(new Integer[]{null}, 0);
            assertFalse(iterator.hasNext());
        }

        @Test
        void hasNext_emptyCapacityMany_returnsFalse() {
            ArrayIterator<Integer> iterator = new ArrayIterator<>(new Integer[]{null, null, null, null, null}, 0);
            assertFalse(iterator.hasNext());
        }

        @Test
        void next_emptyCapacityZero_throwsNoSuchElementException() {
            ArrayIterator<Integer> iterator = new ArrayIterator<>(new Integer[]{}, 0);
            assertThrows(NoSuchElementException.class, () -> iterator.next());
        }

        @Test
        void next_emptyCapacityOne_throwsNoSuchElementException() {
            ArrayIterator<Integer> iterator = new ArrayIterator<>(new Integer[]{null}, 0);
            assertThrows(NoSuchElementException.class, () -> iterator.next());
        }

        @Test
        void next_emptyCapacityMany_throwsNoSuchElementException() {
            ArrayIterator<Integer> iterator = new ArrayIterator<>(new Integer[]{null, null, null, null, null}, 0);
            assertThrows(NoSuchElementException.class, () -> iterator.next());
        }
    }
